...
const MentorLayout: React.FC = () => {
  ...
  const navigationItems = [
    { name: 'Dashboard', to: '/mentor/dashboard', icon: LucideLayoutDashboard },
    { name: 'Sessions', to: '/mentor/sessions', icon: LucideCalendar },
    { name: 'Payouts', to: '/mentor/payouts', icon: LucideDollarSign },
    { name: 'Chat', to: '/mentor/chat', icon: LucideMessageSquare },
    { name: 'Profile', to: '/mentor/profile', icon: LucideUser },
  ];
          ...
          >
            ...
            >
              ...
              <div className="flex-shrink-0 flex items-center px-4">
                <h1 className="text-xl font-bold text-gray-800">EdTech Mentor</h1>
              </div>
        ...
        <div className="flex flex-col w-64">
          <div className="flex flex-col h-0 flex-1">
            <div className="flex items-center h-16 flex-shrink-0 px-4 bg-white border-b border-gray-200">
              <h1 className="text-lg font-bold text-gray-800">EdTech Mentor</h1>
            </div>
